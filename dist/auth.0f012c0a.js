...
function AuthFormHandler(event) {
  ...
  if (login != null && pass != null) {
    authWithEmailAndPassword(login, pass).then(IsToken);
  }
}

function authWithEmailAndPassword(email, password) {
  var apiKey = 'AIzaSyD5rPbLqIhxX1RdUUJdsPOSqJCIZIjfV3o';
  return fetch("https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=".concat(apiKey), {
    method: 'POST',
    body: JSON.stringify({
      email: email,
      password: password,
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/auth.js"], null)
//# sourceMappingURL=/auth.0f012c0a.js.map